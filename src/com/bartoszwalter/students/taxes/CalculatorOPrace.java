 ...
 */
public class CalculatorOPrace implements ICalculator
{
    private static final BigDecimal kosztyUzyskania = new BigDecimal("111.25");
    private static final BigDecimal kwotaWolnaOdPodatku = new BigDecimal("46.33");
    ...
    private BigDecimal podatekPotracony;
    ...
    private void zapiszWyniki()
    {
        ...
        wyniki.add(new Wynik("Koszty uzyskania przychodu w stałej wysokościu", kosztyUzyskania));
        ...
        wyniki.add(new Wynik("Kwota wolna od podatku 18%", kwotaWolnaOdPodatku));
        wyniki.add(new Wynik("Podatek potrącony", podatekPotracony));
    ...
    public void oblicz()
    {
        ...
        podatekPotracony = zaliczkaNaPodatek.subtract(kwotaWolnaOdPodatku);
        zaliczkaDoUS = zaliczkaNaPodatek.subtract(swiadczenieZdrowotne7).subtract(kwotaWolnaOdPodatku);
